...
const link = "http://13.51.69.208:3000/expense/expensetable";
...
async function showexpense(page) {
    ...
    try {
        ...
        const details = await axios.get(`${link}/expense?page=${page}&limit=${expensesPerPage}&offset=${offset}`, { headers: { "Authorization": token } });
        console.log(details);
        ...
        updatePaginationButtons(details.data.page, details.data.totalPages, totalExpenses);
...
document.getElementById('rzy_btn').onclick = async function(e){
    ...
    const response = await axios .get("http://13.51.69.208:3000/purchase/premium", {headers: {"Authorization": token}});
    ...
    var options = {
        ...
        "handler": async function (response){
            try {
                ...
                await axios.post("http://13.51.69.208:3000/purchase/update-premium-status", {
...
async function download(token){
    ...
    await axios.get("http://13.51.69.208:3000/download", { headers: { "Authorization": token } })
